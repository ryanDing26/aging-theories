...
def test_biorxiv_connection():
    """Test BioRxiv API"""
    print("\n🔍 Testing BioRxiv API connection...")
    ...
    try:
        ...
        url = f"http://api.biorxiv.org/details/biorxiv/{start_str}/{end_str}/0/json"
        ...
        print(f"  ✓ BioRxiv accessible ({count} papers in last 30 days)")
        return True
...
def run_test_paper():
    ...
    try:
        agent_file = Path(__file__).parent / "aging_agent_biorxiv.py"
        ...
        print("\n" + "="*80)
        agent.run(
            initial_query="aging mitochondria",
            target_papers=1,
            max_cost_usd=0.50
        )
        print("="*80)
...
""")
    ...
    checks = {
        ...
        "BioRxiv API": test_biorxiv_connection(),
    }
